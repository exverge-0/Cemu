...
ih264_intra_pred_chroma_8x8_mode_plane_av8:
    ...
    sub       x5, x3, #8
#ifdef __APPLE__
    adrp      x12, ih264_gai1_intrapred_chroma_plane_coeffs1@GOTPAGE
    ldr       x12, [x12, ih264_gai1_intrapred_chroma_plane_coeffs1@GOTPAGEOFF]
#else
    ...
    mov       v0.16b, v1.16b
#ifdef __APPLE__
    adrp      x12, ih264_gai1_intrapred_chroma_plane_coeffs2@GOTPAGE
    ldr       x12, [x12, ih264_gai1_intrapred_chroma_plane_coeffs2@GOTPAGEOFF]
#else
